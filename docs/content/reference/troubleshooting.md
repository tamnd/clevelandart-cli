...
Most of these come down to network reality or how clevelandart serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

clevelandart rate-limits like any public site. clevelandart already paces
...
Where a surface is gated, clevelandart reads a cookie or token you supply
...
`clevelandart`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what clevelandart actually did
