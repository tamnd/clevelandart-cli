...
```
clevelandart <command> [arguments] [flags]
```

Run `clevelandart <command> --help` for the full flag list on any command. This
...
per operation you declare in `clevelandart/domain.go`.
