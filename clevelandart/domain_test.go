...
// HTTP behaviour is covered in clevelandart_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "clevelandart://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("clevelandart", "about")
	if err != nil || got.String() != "clevelandart://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want clevelandart://page/about", got.String(), err)
	}
}
